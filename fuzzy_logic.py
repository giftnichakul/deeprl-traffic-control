...
route_path = './saint_paul/1.0hour/trips/3000.rou.xml'

if(useGui): sumoBinary = checkBinary('sumo-gui')
else: sumoBinary = checkBinary('sumo')
sumoCmd = [sumoBinary, "-n", net_file, "-r", route_path, "--no-warnings", "--quit-on-end"]
...
print(total_waiting_time, total_clear_time)
